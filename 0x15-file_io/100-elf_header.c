 ...
 * @e_ident: Pointer to an array containing the ELF magic numbers.
 *
 * Description: The magic numerals are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_version - Print a version of an ELF header.
...
/**
 * print_type - Print the type of an ELF header in ELF file.
 * @e_type: An ELF type.
 * @e_ident: Pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Print the entry point of an ELF header in ELF file.
